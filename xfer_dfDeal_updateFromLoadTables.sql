...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[usp_xferdfDeal]') AND type in (N'P'))
  drop procedure usp_xferdfDeal
go
...
--
--   example sql generated from the above function
--
